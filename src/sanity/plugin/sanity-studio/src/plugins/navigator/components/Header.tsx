...
import { getTemplateName, slugToTitle } from "../utils";
...
function MenuItem(props: {
  ...
  const slugField =
    schemaType?.jsonType === "object"
      ? schemaType.fields.find((field) => field.name === "slug")
      : null;
  const slugCurrentInitialValue: string | undefined =
    slugField?.type.initialValue?.current;
      ...
      {...useIntentLink({
        ...
        params: [
          ...
          },
          {
            slug: getslug({
              currentDir,
              initialValue: slugCurrentInitialValue,
            }),
            locale,
          },
        ],
