...
const myPortableTextComponents = {
  ...
  marks: {
    ...
    link: ({ children, value }) => {
      ...
      return (
        <a
          className="font-bold underline transition-all custom-a text-green hover:text-purple"
          href={value.href}
          rel={rel}
        >
          {children}
  ...
  block: {
    normal: ({ children }) => (<p className="mt-2 mb-4 font-sans custom-p text-regular ">{children}</p>),
