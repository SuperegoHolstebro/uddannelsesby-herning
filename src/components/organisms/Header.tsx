    ...
    <>
      <header className="px-4 xs:px-4 sm:px-13 md:px-0 fixed top-0 left-0 translate-x-0 w-full md:w-[100px] h-auto md:h-full bg-mørk z-[9999999999] transition-all flex flex-row md:flex-col-reverse justify-between items-center">
        ...
        <div className='flex flex-row-reverse items-center gap-6 md:gap-12 md:flex-col'>
          ...
          <div>
            <svg width="40" height="41" viewBox="0 0 40 41" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.75195 20.4669H37.2484" stroke="#D9FC00" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path d="M26.6341 20.4669C26.3082 26.7744 23.985 32.8148 20.0001 37.7151C16.0153 32.8148 13.6921 26.7744 13.3662 20.4669C13.6921 14.1594 16.0153 8.11892 20.0001 3.2187C23.985 8.11892 26.3082 14.1594 26.6341 20.4669Z" stroke="#D9FC00" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path d="M20.0002 37.7151C29.5262 37.7151 37.2484 29.993 37.2484 20.4669C37.2484 10.941 29.5262 3.2187 20.0002 3.2187C10.4742 3.2187 2.75195 10.941 2.75195 20.4669C2.75195 29.993 10.4742 37.7151 20.0002 37.7151Z" stroke="#D9FC00" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/></svg>
